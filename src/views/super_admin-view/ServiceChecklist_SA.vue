<template>
  <section id="ServiceChecklist_SA">
          ...
          <div class="vehicle_tlt d-flex flex-row">
           ...
           <div class="vehicle_lsts_sec add_newvehicle addvehicle_detail">
            ...
            <form>
                ...
                <ul v-if="serviceChecklist.DriverTechnicalmechanicalrevisionexpirationdate != null">
                <li><h5>{{ 'DriveCheckList' | translate }}</h5></li>
              ...
              <ul  class="driver_hgt" v-if="serviceChecklist.DriverTechnicalmechanicalrevisionexpirationdate == null">Waiting for driver update</ul>
             <ul   class="driver_hgt" v-if="serviceChecklist.SpecialistTechnicalmechanicalrevisionexpirationdate == null">Waiting for specialist update</ul>
...
<style scoped>
 ...
 .add_newvehicle form ul{width:98% !important;}
 }

 @media only screen and (min-width:320px) and (max-width:410px)
 {
   .driver_hgt{font-size:16px !important;}
 }
