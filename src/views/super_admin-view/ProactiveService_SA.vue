<template>
  <section id="ProactiveService_SA">
   <div class="container-fluid">
      <div class="row">
      <div class="col-12 main-title">
        <h2>{{ 'PROACTIVESERVICES' | translate }} </h2>
      </div>
       <div class="col-12 content_section">
          ...
          <div class="vehicle_tlt d-flex flex-row">
            ...
            <h4>{{ 'ProactiveServicesList' | translate }} </h4>
            </div>
          </div>
          ...
          <div class="content_section_table quotes_imp">
              ...
              <!--thead>
                <tr>
                   ...
                   <th scope="col" @click="sort('value')">Value<i class="fa fa-sort" aria-hidden="true"></i></th>
                  <th scope="col" @click="sort('creationdate')">Expected Date<i class="fa fa-sort" aria-hidden="true"></i></th>
                  <th scope="col" @click="sort('status')">Status<i class="fa fa-sort" aria-hidden="true"></i></th>
                  <th scope="col" @click="sort('action')">ACTION</th>

                  </tr>
              </thead-->
              <data-tables :data="listData" :action-col="actionCol" >
...
export default {
  ...
  methods: {
      getProactive(){
        ...
        return  this.$store.dispatch("getData",'/SuperAdmin/GetProactive').then(function(response){
  ...
  computed: {
    titles() {
      ...
      buttons: [{
          ...
          handler: row => {
            let id = row.ProactiveId
           // alert(id);
            this.$router.push({path: '/proactive-detail/'+id})
          },
