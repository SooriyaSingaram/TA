        ...
        <div class="col-12 content_section">
          ...
          <div class="vehicle_tlt d-flex flex-row">
           ...
           <div class="vehicle_lsts_sec"  >
            ...
            <p>{{ 'ImagesOfMaintainance' | translate }}  <a class="fon_up">{{Imageslist.data.ModelName}}{{Imageslist.data.BrandName}}{{Imageslist.data.YearName}}{{Imageslist.data.ClassName}} </a>  <span style="text-transform: lowercase;">{{ 'BeforeService' | translate }}</span></p>
            ...
            <div class="d-flex justify-content-between services_img" > 
              <div v-for="Imagesdata in Imageslist">
               ...
               <object width="400" height="400"  v-bind:data="Image">
</object>
 
                <!--iframe  v-bind:src="Image" ></iframe-->
               </div>
            ...
            <p>{{ 'ImagesOfMaintainance' | translate }}  <a class="fon_up">{{Imageslist.data.ModelName}}{{Imageslist.data.BrandName}}{{Imageslist.data.YearName}}{{Imageslist.data.ClassName}} </a>  <span style="text-transform: lowercase;">{{ 'AfterService' | translate }}</span></p>
