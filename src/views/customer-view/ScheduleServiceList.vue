<template>
  <section id="ScheduleServiceList">
 ...
 data() {
  ...
  methods: {
      ...
      //"CarOwnerServiceId": 
   	...
   	getScheduleServiceParam() {
            ...
            //     console.log(localStorage.getItem('userId')); 
               ...
               // let userid = 2;
			          this.$store.dispatch("getscheduleserviceList", userid);
   ...
   computed: {
    ...
    ...mapGetters({
      data: "getscheduleserviceList"
    }),
     searchData() {
       
      this.dropdown=  [...new Set(this.data.map(item => item.VehicleName))];
     
      
      return this.data.filter(post => {
       
        return post.VehicleName.toLowerCase().includes(
...
props: {
  	...
  	watch: {
		'getscheduleserviceList': {
			...
			handler(value) {
				this.data = null
				this.data = this.getscheduleserviceList;
